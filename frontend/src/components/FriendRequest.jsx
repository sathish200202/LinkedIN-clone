  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 flex items-center justify-between transition-all hover:shadow-md">
      ...
      <div className="space-x-2">
        <button
          className="bg-gray-200 text-blue-600 px-4 py-2 rounded-md hover:bg-primary hover:text-white transition-colors"
          onClick={() => acceptConnectionRequest(request._id)}
        >
          Accept
        </button>
        <button
          className="bg-gray-200 text-rose-500 px-4 py-2 rounded-md hover:bg-rose-400 hover:text-white transition-colors"
