...
const ProfileHeader = ({ userData, onSave, isOwnProfile, isLoading }) => {
  ...
  //get the connection status query
  ...
  //get the connection status for rendering a button
  ...
  //render the different connection button
